...
# Form implementation generated from reading ui file 'd:\VScode\vscode_project\py39_hmi\ui\serial_setting_dialog.ui'
#
...
class Ui_SerialSettingDialog(object):
    def setupUi(self, SerialSettingDialog):
        ...
        SerialSettingDialog.resize(200, 220)
    ...
    def retranslateUi(self, SerialSettingDialog):
        ...
        self.Label.setText(_translate("SerialSettingDialog", "波特率"))
        ...
        self.cb_baud_rate.setItemText(4, _translate("SerialSettingDialog", "256000"))
        self.Label_2.setText(_translate("SerialSettingDialog", "数据位"))
        ...
        self.Label_3.setText(_translate("SerialSettingDialog", "停止位"))
        self.cb_stop.setItemText(0, _translate("SerialSettingDialog", "1"))
        self.cb_stop.setItemText(1, _translate("SerialSettingDialog", "1.5"))
        self.cb_stop.setItemText(2, _translate("SerialSettingDialog", "2"))
        self.Label_4.setText(_translate("SerialSettingDialog", "校验位"))
        self.Label_5.setText(_translate("SerialSettingDialog", "流控制"))
